...
CREATE TABLE doctor_service_assignments (
  id SERIAL PRIMARY KEY,
...
CREATE INDEX idx_doctor_service_assignments_doctor ON doctor_service_assignments (doctor_id);
CREATE INDEX idx_doctor_service_assignments_service ON doctor_service_assignments (service_id);
...
CREATE INDEX idx_doctor_weekly_schedules_doctor ON doctor_weekly_schedules (doctor_id);
CREATE INDEX idx_doctor_weekly_schedules_weekday ON doctor_weekly_schedules (weekday);
